...
//   return (
//     <div className="flex min-h-screen flex-col items-center justify-center px-2 py-8 sm:px-0 bg-background">
//       <BackgroundGradient className="w-full max-w-5xl mx-auto">
//         <Card className="shadow-xl rounded-2xl bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md border-none">
//           <CardHeader>
...
//                                 size="sm"
//                                 onClick={() =>
//                                   router.push(`/room/join?event=${event.id}`)
//                                 }
//                               >
//                                 Join
//                               </Button>
